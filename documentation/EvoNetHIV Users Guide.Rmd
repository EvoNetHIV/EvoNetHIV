...
[Stochastic, agent-based model](https://github.com/EvoNetHIV/EvoNet/blob/master/documentation/EvoNetHIV%20Users%20Guide.Rmd#Stochastic)  
[Components of the model](https://github.com/EvoNetHIV/EvoNet/blob/master/documentation/EvoNetHIV%20Users%20Guide.Rmd#Components)  
...
EvoNetHIV is an HIV epidemic simulation model that incorporates within-host dynamics, sexual network structure, viral load variation, treatment, condom use, circumcision, demography, and HIV evolution. 
...
### Stochastic, agent-based model{Stochastic}
...
### Components of the EvoNetHIV model{Components}
