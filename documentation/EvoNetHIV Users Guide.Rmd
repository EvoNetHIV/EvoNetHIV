...
[Model overview](https://github.com/EvoNetHIV/EvoNet/blob/master/documentation/EvoNetHIV%20Users%20Guide.Rmd#Model-overview)  
...
EvoNetHIV uses a modular framework from the [EpiModel](http://www.epimodel.org/) API. EvoNetHIV has inter-connected components that result in epidemiological and evolutionary dynamics:  network structure; sexual behavior; within-host dynamics (viral load, disease progression), and treatment or other public health interventions. All components operate at the scale of the agent. The aggregate dynamics or values across agents give epidemiological and population level dynamics.
