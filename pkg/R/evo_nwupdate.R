...
{
  #note, this function is slight modification of epimodel's
  # "nwupdate.net()". Just a couple lines commented out, see
  #lines 20-27
  ...
  if (nArrivals > 0) {
    ...
    #epimodel code commented out for evonet as evonet 
    #as evonet has own functions for calculating new values of agent attributes for
    #new arrivals to model
    #if (!is.null(nwterms)) {
