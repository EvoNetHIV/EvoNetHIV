...
# Define new sequences to identify viruses with 0, 1, 2, 3, or 4 mutations  
  ...
  seq3 <- c(8,12,14,15,20,22,23,26,27,29) #3 mutations
...
M184V <- c(3,4,7,8,11,12,15,16, 3+16,4+16,7+16,8+16,11+16,12+16,15+16,16+16)  # 3TC resistance
K103N <- c(5,6,7,8,13,14,15,16, 5+16,6+16,7+16,8+16,13+16,14+16,15+16,16+16)    # EFV resistance
...
# The following is the binary coding translation table for mutation ids 
# (indicated in lines 50-62)
#
#   Num binary   Muts
#     1  00000  - 0
#     2  00001  - 1
