#' @export
evo_initialize <- function(x, param, init, control, s) {
  #originally from Skye. B.
  #https://github.com/statnet/EpiModel/blob/fast_edgelist/R/net.mod.init.R
  #replaces base EpiModel "initialize.net" to handle base epimodel or tergmlite runs
  ...
  if (control$start == 1) {
    ...
    dat$temp$t1.tab <- get_attr_prop(nw, fterms)
